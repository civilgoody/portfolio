          ...
          <div className="flex justify-center space-x-6">
            {SOCIAL_LINKS.map((social, index) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`text-secondary-foreground hover:cursor-pointer hover:text-primary transition-all duration-300 transform hover:scale-110 precision-focus animate-element-flow`}
                // style={{ animationDelay: `${index * 0.2}s` }}
                aria-label={social.label}
              >
                <SocialIcon icon={social.icon} />
